...
carbon_upsampled = resample(
    carbon, replace=True, n_samples=len(fluorine), random_state=42
)
...
grid_search = GridSearchCV(
    estimator=bdt, param_grid=param_grid, cv=5, scoring="accuracy", n_jobs=-1, verbose=2
)
